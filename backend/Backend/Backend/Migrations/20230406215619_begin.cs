        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dislike = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AddedToPlaylist = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    TimeWatchedSec = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVideoStats", x => new { x.UserId, x.VideoId });
                })
                .Annotation("MySql:CharSet", "utf8mb4");
